    ...
    <div class="container py-md-5">
        <div class="row align-items-center">
          <div class="col-lg-7 py-3 py-md-5">
            ...
            <p class="lead text-muted"> <span id="current-date">{{ now()->format('F j, Y') }}</span>, 
              <span id="current-time">{{ now()->format('h:i:s A') }}</span></p>
          </div>
        ...
        @enderror
              ...
              <div class="form-group">
                ...
                <input name="fullname" id="username-register" class="form-control" type="text" placeholder="Pick a username" autocomplete="off" />
                @error('fullname')
            <div class="text-danger">{{ $message }}</div>
        @enderror
              </div>
